          ...
          <div className="row d-flex align-items-center weather">
            <div className="col-sm">
              <ul className="todayWeather">
                <li className="current-icon">{props.cityData.icon}</li>
            ...
            <div className="col-sm">
              <ul className="text-left todayHumidityWind">
                ...
                <FontAwesomeIcon icon={faTemperatureHigh} />
                  <span className="extras">Feels like: {props.cityData.feelsLike}°C</span>
                </li>
                <li><FontAwesomeIcon icon={faTint} /><span className="extras-humidity">Humidity: {props.cityData.humidity}%</span>
                </li>
                <li>
                  <FontAwesomeIcon icon={faWind} /><span className="extras">Wind: {props.cityData.wind} km/h</span>
                </li>
              </ul>
            </div>
          </div>
